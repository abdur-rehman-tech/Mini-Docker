...
import type {ColorInfo, ColorSupportLevel} from 'supports-color';
...
*/
export declare const Chalk: new (options?: Options) => ChalkInstance; // eslint-disable-line @typescript-eslint/naming-convention
...
Basic modifier names.
*/
export declare const modifiers: readonly Modifiers[];
...
Basic foreground color names.
*/
export declare const foregroundColors: readonly ForegroundColor[];
...
Basic background color names.
*/
export declare const backgroundColors: readonly BackgroundColor[];
