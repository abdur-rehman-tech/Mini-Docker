 ...
 * @internal
 */
export declare type Children = PathBase[] & {
    provisional: number;
};
...
export declare type WalkOptionsWithFileTypesUnset = WalkOptions & {
    withFileTypes?: undefined;
};
export declare type WalkOptionsWithFileTypesTrue = WalkOptions & {
    withFileTypes: true;
};
export declare type WalkOptionsWithFileTypesFalse = WalkOptions & {
    withFileTypes: false;
};
/**
...
export declare type Path = PathBase | InstanceType<typeof Path>;
/**
...
export declare type PathScurry = PathScurryBase | InstanceType<typeof PathScurry>;
export {};
