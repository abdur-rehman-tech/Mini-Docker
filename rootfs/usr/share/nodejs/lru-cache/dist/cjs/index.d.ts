...
declare type UintArray = Uint8Array | Uint16Array | Uint32Array;
declare type NumberArray = UintArray | number[];
declare class ZeroArray extends Array<number> {
    constructor(size: number);
}
declare type StackLike = Stack | Index[];
declare class Stack {
    #private;
    heap: NumberArray;
    length: number;
 ...
 */
export declare type BackgroundFetch<V> = Promise<V | undefined> & {
