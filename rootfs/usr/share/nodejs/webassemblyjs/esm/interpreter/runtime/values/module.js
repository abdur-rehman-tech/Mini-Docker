...
function instantiateImports(n, allocator, externalElements, internals, moduleInstance) {
  ...
  function handleFuncImport(node, descr) {
    ...
    var externFuncinstance = externvalue.createFuncInstance(element,
    // $FlowIgnore
    params, results);
    var externFuncinstanceAddr = allocator.malloc(1 /* sizeof externFuncinstance */);
  ...
  function handleGlobalImport(node, descr) {
    ...
    var addr = allocator.malloc(1 /* size of the globalinstance struct */);
  ...
  function handleMemoryImport(node) {
    ...
    var addr = allocator.malloc(1 /* size of the memoryinstance struct */);
  ...
  function handleTableImport(node) {
    ...
    var addr = allocator.malloc(1 /* size of the tableinstance struct */);
...
function instantiateInternals(funcTable, n, allocator, internals, moduleInstance) {
  ...
  traverse(n, {
    Func: function (_Func) {
      ...
      var addr = allocator.malloc(1 /* size of the funcinstance struct */);
...
function instantiateExports(n, allocator, internals, moduleInstance) {
  ...
  function createModuleExport(node,
...
export function createInstance(funcTable, allocator, n) {
