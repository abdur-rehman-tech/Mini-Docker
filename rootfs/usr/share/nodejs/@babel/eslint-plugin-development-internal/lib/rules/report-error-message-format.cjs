...
module.exports = {
  ...
  create({
    ...
    return {
      "CallExpression[callee.type='Identifier'][callee.name='makeErrorTemplates'] > ObjectExpression > Property[value.type='Literal']"(node) {
        const {
          value
        } = node;
...
//# sourceMappingURL=report-error-message-format.cjs.map
