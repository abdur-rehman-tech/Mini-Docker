...
const hasPromiseAPI = (value) => is.function_(value === null || value === void 0 ? void 0 : value.then) &&
    is.function_(value === null || value === void 0 ? void 0 : value.catch);
...
exports.assert = {
    ...
    any: (predicate, ...values) => {
        return assertType(is.any(predicate, ...values), "predicate returns truthy for any value" /* AssertionTypeDescription.any */, values, { multipleValues: true });
    },
