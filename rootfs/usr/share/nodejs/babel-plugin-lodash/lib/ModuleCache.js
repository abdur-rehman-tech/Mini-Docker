...
/*----------------------------------------------------------------------------*/
var ModuleCache = /*#__PURE__*/function (_MapCache) {
  ...
  function ModuleCache(moduleRoot) {
    ...
    var mainPath = (0, _util.normalizePath)(_path.default.dirname(_path.default.resolve(moduleRoot, pkgMain)));

    // Sort paths by the “main” entry first.
    var dirPaths = (0, _orderBy2.default)(_glob.glob.sync(_path.default.join(moduleRoot, '**/'), {
    ...
    (0, _each2.default)(dirPaths, function (dirPath) {
      ...
      var filePaths = _glob.glob.sync(_path.default.join(dirPath, '*.js'));
